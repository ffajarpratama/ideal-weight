...
public class MountainClimbersTimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mountain_climbers_timer);
    ...
    private void startTimer(){
        countDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                Intent myIntent = new Intent(getBaseContext(), BurpeesTimer.class);
                startActivity(myIntent);
            }
        }.start();
        mTimerRunning = true;

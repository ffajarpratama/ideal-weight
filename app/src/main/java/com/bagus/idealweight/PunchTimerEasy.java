...
public class PunchTimerEasy extends AppCompatActivity {
    ...
    public static final long START_TIME_IN_MILLIS = 45000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_punch_timer_easy);
    ...
    private void startTimer(){
        countDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                Intent myIntent = new Intent(getBaseContext(), JumpingJacksTimerEasy.class);
                startActivity(myIntent);
            }
        }.start();
        mTimerRunning = true;

...
public class JumpingJacksTimerEasy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jumping_jacks_timer_easy);
    ...
    private void startTimer(){
        countDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                Intent myIntent = new Intent(getBaseContext(), Rest.class);
                startActivity(myIntent);
            }
        }.start();
        mTimerRunning = true;

...
public class HephaestusTimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hephaestus_timer);
    ...
    private void startTimer(){
        countDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                Intent myIntent = new Intent(getBaseContext(), PunchTimerEasy.class);
                startActivity(myIntent);
            }
        }.start();
        mTimerRunning = true;

...
public class BurpeesTimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_burpees_timer);
    ...
    private void startTimer(){
        countDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                Intent myIntent = new Intent(getBaseContext(), JoggingTimer.class);
                startActivity(myIntent);
            }
        }.start();
        mTimerRunning = true;
